...
const BatchAdminDashboard = () => {
  ...
  const getRoleDisplay = () => {
    ...
    if (user?.role === 'BATCH_ADMIN') return 'Batch Admin';
    return 'Admin';
  };
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <div className={`mt-1 text-sm ${
                    ...
                    <p>
                      {isPending 
                        ? 'Your alumni status is currently being reviewed. You have batch admin access while verification is pending.'
                        : 'Please complete your alumni verification to access all portal features as a batch admin.'
                      }
                    </p>
                  </div>
                </div>
...
export default BatchAdminDashboard;