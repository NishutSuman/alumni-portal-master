              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <div className={`mt-1 text-sm ${
                    ...
                    <p>
                      {isPending 
                        ? 'Your alumni status is currently being reviewed. You have admin access while verification is pending.'
                        : 'Please complete your alumni verification to access all portal features as an admin.'
                      }
                    </p>
                  </div>
                </div>
